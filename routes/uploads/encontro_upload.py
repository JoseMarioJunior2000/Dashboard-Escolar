...
import os
from services.repository_instances import encontro_repo
# Cria o blueprint para o upload
encontro_upload_blueprint = Blueprint('encontro_upload', __name__)
...
@encontro_upload_blueprint.route('/upload_xlsm', methods=['POST'])
def upload_xlsm():
    ...
    if file and file.filename.endswith('.xlsm'):
        ...
        aspirante_response = encontro_repo.insert_excel(file_path)
